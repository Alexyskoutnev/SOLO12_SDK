...
// constexpr double index_offset[motor_count] = {4.26285, 2.03286, -3.54795, 4.92864,
// -5.06801, 1.21595, 4.32513, 4.23617, 4.26034, 2.6877, 4.14373, 0.0895862};
...
static std::map<control_state, std::string> control_type_2_name{
    {control_state::P_CONTROL, "P_CONTROL"},
    {control_state::PD_CONTROL, "PD_CONTROL"},
    {control_state::TORQUE, "TORQUE"}};
